...
@Composable
fun InsuranceInfoSection(insuranceInfo: InsuranceInfo) {
    Column(
        modifier = Modifier
        ...
        Icon(
            ImageVector.vectorResource(id = insuranceInfo.iconRes),
            contentDescription = insuranceInfo.title,
            modifier = Modifier
                .size(34.dp)
                .padding(start = 8.dp),
        )
        ...
        Text(
            text = insuranceInfo.description,
            modifier = Modifier
                .padding(top = 10.dp)
                .fillMaxWidth(),
            style = TextStyle(
